    ...
    return (
        <div className="landing">
            ...
            ref={(el) => (sectionRefs.current[3] = el)} >
              <h1>
                Mit deinem Task Manager behältst du endlich den Überblick über deine Aufgaben, Projekte und Ziele – ganz ohne Chaos, verpasste Deadlines oder überfüllte To-Do-Listen.
              </h1> 
          </div>
        </div>
    );
